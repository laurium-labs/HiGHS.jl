...
@testset "Objective function and value in box constraints" begin
    ...
    HiGHS.Highs_changeColCost(o.inner, Cint(x.value), 1.0)
    ...
    HiGHS.Highs_changeColCost(o.inner, Cint(x.value), 2.0)
    MOI.optimize!(o)
    # BUG in HiGHS
...
@testset "Column intervals and bounds" begin
    ...
    @test MOI.supports_constraint(o, MOI.SingleVariable, MOI.Interval)
